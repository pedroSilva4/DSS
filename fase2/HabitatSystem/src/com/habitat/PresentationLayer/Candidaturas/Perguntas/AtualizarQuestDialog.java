 ...
 * @author Pedro
 */
public class AtualizarQuestDialog extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AtualizarQuestDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AtualizarQuestDialog dialog = new AtualizarQuestDialog(new javax.swing.JFrame(), true);
